declare namespace JsonSchemastoreOrg {
	export interface Tslint {
		...
		rules?: Tslint.Definitions.Ruledefinitions;
		jsRules?: Tslint.Definitions.Jsruledefinitions;
		/**
	...
	namespace Tslint {
		namespace Definitions {
			export interface Jsruledefinitions {
				 ...
				 */
				"ordered-imports"?: ({}|boolean|string)[];
				/**
				 ...
				 */
				"trailing-comma"?: ({}|boolean|string)[];
				/**
				 * Enforces === and !== in favor of == and !=
				 */
				"triple-equals"?: ("true"|"false"|"allow-null-check"|"allow-undefined-check")[]|boolean;
				/**
			...
			export interface Ruledefinitions {
				 ...
				 * Requires parentheses around the parameters of arrow function definitions
				 */
				"arrow-parens"?: boolean|("true"|"false"|"ban-single-arg-parens")[];
				/**
				 * Bans the use of specific functions or global methods
				 */
				ban?: boolean|(boolean|any[])[];
				 ...
				 */
				"member-access"?: ("true"|"false"|"check-accessor"|"check-constructor")[]|boolean;
				/**
				 ...
				 */
				"no-unused-variable"?: (boolean|string|{})[]|boolean;
				/**
				 * Disallows usage of variables before their declaration
				 */
				"no-use-before-declare"?: boolean;
